 ...
 * @version V1.0
 */
@Service("NscXxMxService")
@Transactional
public class NscXxMxServiceImpl extends CommonServiceImpl implements NscXxMxServiceI{
	@Autowired
...
//	}
	...
	public List<Map<String, Object>> querySingle(String table, String field, String params,
...
//--------longjb-end--20150526 ----for:add step.3 判断是否有附件字段,进行连带删除附件及附件表---------------
	...
	@SuppressWarnings("unchecked")
	private void dealQuerySql(String table, String field, String params,StringBuilder sqlB){
		sqlB.append(" SELECT ");
		...
		if (!StringUtil.isEmpty(params) && !"null".equalsIgnoreCase(params)) {
				sqlB.append(" AND ");
				sqlB.append(" " + params );
		}
	...
	public Long getQuerySingleSize(String table, String field, String params) {
		StringBuilder sqlB = new StringBuilder();

...
<head>
 ...
 <body>
  <form id="formobj" action="nsc数据表Controller.do?doAdd" name="formobj" method="post"><input type="hidden" id="btn_sub" class="btn_sub"/>
			...
			<div class="tab-wrapper">
			    ...
			    <div class="con-wrapper" style="display: block;">
			      <div class="row form-wrapper">
			          ...
			          <div class="col-xs-3">
								<input id="数据表编号" name="数据表编号" type="text" class="form-control"  >
			          ...
			          <div class="col-xs-3">
								<input id="泵组序号" name="泵组序号" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="数据表版本" name="数据表版本" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="项目名称" name="项目名称" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="客户单位" name="客户单位" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								...
								typeGroupCode="NSC泵组类型" hasLabel="false"  title="泵组类型"></t:dictSelect>     
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="需要台数" name="需要台数" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="操作备用" name="操作备用" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="泵型号" name="泵型号" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="流量" name="流量" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="扬程" name="扬程" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="输送介质" name="输送介质" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="操作温度" name="操作温度" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="密度" name="密度" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="入口压力" name="入口压力" type="text" class="form-control" datatype="*" >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="出口压力" name="出口压力" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="腐蚀" name="腐蚀" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="粘度" name="粘度" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="固体颗粒" name="固体颗粒" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								...
								typeGroupCode="室内外" hasLabel="false"  title="安装位置"></t:dictSelect>     
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="海拔高度" name="海拔高度" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								...
								typeGroupCode="否是" hasLabel="false"  title="运行条件(是否防爆)"></t:dictSelect>     
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="销售人员" name="销售人员" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="销售人员日期" name="销售人员日期" type="text" style="width: 150px"  class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="技术支持" name="技术支持" type="text" class="form-control"  >
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
			          ...
			          <div class="col-xs-3">
								<input id="技术支持日期" name="技术支持日期" type="text" style="width: 150px"  class="form-control" onClick="WdatePicker()"  type="date" pattern="yyyy-MM-dd"/>'>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>

	...
	<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
		...
		<c:if test="${user.id==null }">
			<tr>
				...
				<td class="value">
                    <input type="password" class="inputxt" value="" name="password" plugin="passwordStrength" datatype="*1-18" errormsg="" />
			...
			<tr>
				...
				<td class="value">
                    <input id="repassword" class="inputxt" type="password" value="${user.password}" recheck="password" datatype="*1-18" errormsg="两次输入的密码不一致！">

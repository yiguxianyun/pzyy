	...
	<table style="width: 550px" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
			...
			<tr>
				...
				<td class="value"><input type="password" class="inputxt" value="" name="password" plugin="passwordStrength" datatype="*1-18" errormsg="" /> <span class="passwordStrength"
			...
			<tr>
				...
				<td class="value"><input id="repassword" class="inputxt" type="password"  recheck="password" datatype="*1-18" errormsg="两次输入的密码不一致！"> <span

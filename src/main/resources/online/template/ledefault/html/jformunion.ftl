...
//});
 ...
 <body>
  <form id="formobj" action="cgFormBuildController.do?saveOrUpdateMore" name="formobj" method="post">
		<#if tableName=="nsc_sj">
			<#include "online/template/ledefault/htmlkk/nsc_sj.ftl">
		<#elseif tableName=="长轴泵_算价" >
			<#include "online/template/ledefault/htmlkk/长轴泵_算价.ftl">
		<#else>
	...
	<#list subtablelist as sub >
	    <#if field['${sub}']?exists >
	    	...
	    	<#elseif sub=="nsc_sj_dj" >
	    		<#include "online/template/ledefault/htmlkk/nsc_sj_dj.ftl">
	    	...
	    	<#elseif sub=="长轴泵_算价_泵" >
	    		<#include "online/template/ledefault/htmlkk/长轴泵_算价_泵.ftl">

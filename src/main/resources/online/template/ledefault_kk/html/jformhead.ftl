...
<div class="tab-wrapper" id="toubu">
    <!-- tab -->
    <ul class="nav nav-tabs">
      <li role="presentation" class="active"><a href="javascript:void(0);">${head.content}</a></li>
      <input type="button" value="保存"  id="btn_sub" class="ui_state_highlight" style="margin-left: 10px;"/>
      <#if tableName=="nsc_xx">			      
	      <input type="button" value="保存*"  id="bcun" class="ui_state_highlight" style="margin-left: 10px;"/>
	      <input type="button" value="保存 → 算价"  id="bcunSJ" class="ui_state_highlight" style="margin-left: 10px;"/>
      </#if>  
      <input type="button" value="刷新"  id="shuax" class="ui_state_highlight" style="float:right;margin-right: 30px;"/>
    </ul>
    <!-- tab内容 -->
	...
	<#if (po_index%3==0)&&(!po_has_next)>
		<div class="col-xs-2 text-center"><b></b></div>
        <div class="col-xs-4"></div>
	</#if>
	<#if (po_index%3=2)||(!po_has_next)>
		</div>
	</#if>

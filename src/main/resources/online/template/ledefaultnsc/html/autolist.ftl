${config_iframe}
<script type="text/javascript" src="plug-in/tools/curdtools_kk.js"></script>
...
function createDataGrid${config_id}(){
	...
	//新增
	function ${config_id}kkadd(){

		//add('${config_name}录入','rest/cgform/form/${config_id}','${config_id}List',${config_id}Fw,${config_id}Fh);

		
		kkadd('${config_name}录入','cgFormBuildController.do?goAddFtlForm&tableName=${config_id}&olstylecode=${_olstylecode}','${config_id}List',${config_id}Fw,${config_id}Fh);
	}
	//修改
	function ${config_id}updatekk(){
		...
		updatekk('${config_name}编辑','cgFormBuildController.do?goUpdateFtlForm&tableName=${config_id}&olstylecode=${_olstylecode}','${config_id}List',${config_id}Fw,${config_id}Fh);
	}
	//查看
...
<#if config_querymode == "group">
	...
	<a  id="add" href="cgFormBuildController.do?goAddFtlForm&tableName=${config_id}&olstylecode=${_olstylecode}"  class="easyui-linkbutton" plain="true"  icon="icon-add" target="_blank">录入</a>
